...
public class PaymentController {
    ...
    @GetMapping("/check-in")
    public ResponseEntity<?> checkIn(Authentication authentication, String parkingId) {
        try {

            return new ResponseEntity(new SuccessfulResponseModel(parkingId), HttpStatus.OK);
        } catch (Exception ex) {
